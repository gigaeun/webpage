					...
					<!-- Content -->
						<div id="content" class="12u skel-cell-important">
							<section>
								<header>
									<h2>공지사항 등록</h2>
									<span class="byline">공지사항 등록 페이지</span>
								</header>
								<p>
								<form action="noticeJoinOk" method="post" 
										     enctype="multipart/form-data">
									<table border = 1>
										<tr><th>공지번호</th>
											<td><input type="text" name="noticeNo" value="${autoNum }"/></td></tr>										
										<tr><th>분류</th>
											<td><textarea type="text" name="noticeKind"></textarea></td></tr>		
										<tr><th>제목</th>
											<td><input type="text" name="noticeTitle" /></td></tr>
										<tr><th>내용</th>
											<td><textarea rows="6" cols="30" name="noticeContent"></textarea></td></tr>										
										<tr><th colspan="2">
