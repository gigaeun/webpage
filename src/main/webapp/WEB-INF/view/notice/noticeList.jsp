					...
					<!-- Content -->
						<div id="content" class="12u skel-cell-important">
							<section>
								<header>
									<h2>공지사항 리스트</h2>
									<span class="byline">공지사항 리스트 페이지</span>
								</header>
								<p>
								<table border = 1>
									<tr><td>공지번호</td><td>분류</td><td>제목</td></tr>
									<c:forEach items="${noticeList}" var="dto">
									<tr><td><a href="noticeInfo?noticeNo=${dto.noticeNo }">${dto.noticeNo }</a></td><td>${dto.noticeKind }</td><td>${dto.noticeTitle }</td></tr>
									</c:forEach>
								</table>
								<a href="noticeJoin">공지사항 등록</a>
								</p>
							</section>
						</div>
					<!-- /Content -->
